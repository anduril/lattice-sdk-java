...
private static final long serialVersionUID = 0L;
  ...
  private Ontology(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private Ontology() {
    descriptors_ =
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < descriptors_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, descriptors_.getRaw(i));
    }
    if (template_ != com.anduril.entitymanager.v1.Template.TEMPLATE_INVALID.getNumber()) {
      output.writeEnum(2, template_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(platformType_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, platformType_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(specificType_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, specificType_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(krn_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, krn_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(platformType_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, platformType_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(specificType_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, specificType_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(krn_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, krn_);
    }
