...
private static final long serialVersionUID = 0L;
  ...
  private StreamTasksRequest(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final int EXCLUDE_PREEXISTING_TASKS_FIELD_NUMBER = 4;
  private boolean excludePreexistingTasks_ = false;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public boolean getExcludePreexistingTasks() {
    return excludePreexistingTasks_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (excludePreexistingTasks_ != false) {
      output.writeBool(4, excludePreexistingTasks_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (excludePreexistingTasks_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(4, excludePreexistingTasks_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getExcludePreexistingTasks()
        != other.getExcludePreexistingTasks()) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + EXCLUDE_PREEXISTING_TASKS_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
        getExcludePreexistingTasks());
  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      excludePreexistingTasks_ = false;
      return this;
    }
    ...
    private void buildPartial0(com.anduril.taskmanager.v1.StreamTasksRequest result) {
      ...
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.excludePreexistingTasks_ = excludePreexistingTasks_;
      }
    }
    ...
    public Builder mergeFrom(com.anduril.taskmanager.v1.StreamTasksRequest other) {
      ...
      if (other.getExcludePreexistingTasks() != false) {
        setExcludePreexistingTasks(other.getExcludePreexistingTasks());
      }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              excludePreexistingTasks_ = input.readBool();
    ...
    private boolean excludePreexistingTasks_ ;
    /**
     * <pre>
     * Optional flag to only include tasks created or updated after the stream is initiated, and not any previous preexisting tasks.
     * If unset, the stream will include any new tasks and task updates, as well as all preexisting tasks.
     ...
     *
     * <code>bool exclude_preexisting_tasks = 4 [json_name = "excludePreexistingTasks"];</code>
     * @param value The excludePreexistingTasks to set.
     * @return This builder for chaining.
     */
    public Builder setExcludePreexistingTasks(boolean value) {

      excludePreexistingTasks_ = value;
      bitField0_ |= 0x00000008;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder clearExcludePreexistingTasks() {
