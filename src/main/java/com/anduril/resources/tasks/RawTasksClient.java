...
public class RawTasksClient {
     ...
     * to provide progress information back to Tasks API.</p>
     */
    public LatticeHttpResponse<Iterable<ListenAsAgentStreamResponse>> listenAsAgentStream() {
        return listenAsAgentStream(AgentStreamRequest.builder().build());
    }
     ...
     * to provide progress information back to Tasks API.</p>
     */
    public LatticeHttpResponse<Iterable<ListenAsAgentStreamResponse>> listenAsAgentStream(AgentStreamRequest request) {
        return listenAsAgentStream(request, null);
    }
    ...
    public LatticeHttpResponse<Iterable<ListenAsAgentStreamResponse>> listenAsAgentStream(
        ...
        try {
            ...
            if (response.isSuccessful()) {
                return new LatticeHttpResponse<>(
                        Stream.fromSse(ListenAsAgentStreamResponse.class, new ResponseBodyReader(response)), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
                switch (response.code()) {
