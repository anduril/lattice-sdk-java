...
public class AsyncRawTasksClient {
     ...
     * to provide progress information back to Tasks API.</p>
     */
    public CompletableFuture<LatticeHttpResponse<Iterable<ListenAsAgentStreamResponse>>> listenAsAgentStream() {
    ...
    public CompletableFuture<LatticeHttpResponse<Iterable<ListenAsAgentStreamResponse>>> listenAsAgentStream(
        ...
        CompletableFuture<LatticeHttpResponse<Iterable<ListenAsAgentStreamResponse>>> future =
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new LatticeHttpResponse<>(
                                Stream.fromSse(ListenAsAgentStreamResponse.class, new ResponseBodyReader(response)),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
