...
public final class TaskStreamRequestStatusFilterStatusesItem {
    public static final TaskStreamRequestStatusFilterStatusesItem STATUS_WILCO =
            new TaskStreamRequestStatusFilterStatusesItem(Value.STATUS_WILCO, "STATUS_WILCO");

    public static final TaskStreamRequestStatusFilterStatusesItem STATUS_DONE_OK =
            new TaskStreamRequestStatusFilterStatusesItem(Value.STATUS_DONE_OK, "STATUS_DONE_OK");

    public static final TaskStreamRequestStatusFilterStatusesItem STATUS_VERSION_REJECTED =
            new TaskStreamRequestStatusFilterStatusesItem(Value.STATUS_VERSION_REJECTED, "STATUS_VERSION_REJECTED");

    public static final TaskStreamRequestStatusFilterStatusesItem STATUS_MACHINE_RECEIPT =
            new TaskStreamRequestStatusFilterStatusesItem(Value.STATUS_MACHINE_RECEIPT, "STATUS_MACHINE_RECEIPT");

    public static final TaskStreamRequestStatusFilterStatusesItem STATUS_INVALID =
            new TaskStreamRequestStatusFilterStatusesItem(Value.STATUS_INVALID, "STATUS_INVALID");

    public static final TaskStreamRequestStatusFilterStatusesItem STATUS_WAITING_FOR_UPDATE =
            new TaskStreamRequestStatusFilterStatusesItem(Value.STATUS_WAITING_FOR_UPDATE, "STATUS_WAITING_FOR_UPDATE");

    public static final TaskStreamRequestStatusFilterStatusesItem STATUS_SCHEDULED_IN_MANAGER =
            new TaskStreamRequestStatusFilterStatusesItem(
                    Value.STATUS_SCHEDULED_IN_MANAGER, "STATUS_SCHEDULED_IN_MANAGER");
    ...
    TaskStreamRequestStatusFilterStatusesItem(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof TaskStreamRequestStatusFilterStatusesItem
                        && this.string.equals(((TaskStreamRequestStatusFilterStatusesItem) other).string));
    }
    ...
    public static TaskStreamRequestStatusFilterStatusesItem valueOf(String value) {
        switch (value) {
            case "STATUS_WILCO":
                return STATUS_WILCO;
            case "STATUS_DONE_OK":
