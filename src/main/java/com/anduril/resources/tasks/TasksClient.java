...
public class TasksClient {
     ...
     * to provide progress information back to Tasks API.</p>
     */
    public Iterable<ListenAsAgentStreamResponse> listenAsAgentStream() {
        return this.rawClient.listenAsAgentStream().body();
    }
     ...
     * to provide progress information back to Tasks API.</p>
     */
    public Iterable<ListenAsAgentStreamResponse> listenAsAgentStream(AgentStreamRequest request) {
        return this.rawClient.listenAsAgentStream(request).body();
    }
    ...
    public Iterable<ListenAsAgentStreamResponse> listenAsAgentStream(
        ...
        return this.rawClient.listenAsAgentStream(request, requestOptions).body();
    }
}
