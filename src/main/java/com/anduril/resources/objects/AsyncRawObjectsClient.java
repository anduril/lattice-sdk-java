...
public class AsyncRawObjectsClient {
     ...
     */
    public CompletableFuture<LatticeHttpResponse<SyncPagingIterable<DeletedObjectEntry>>> listDeletedObjects() {
    ...
    public CompletableFuture<LatticeHttpResponse<SyncPagingIterable<DeletedObjectEntry>>> listDeletedObjects(
        ...
        CompletableFuture<LatticeHttpResponse<SyncPagingIterable<DeletedObjectEntry>>> future =
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                        ListDeletedObjectsResponse parsedResponse = ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, ListDeletedObjectsResponse.class);
                        Optional<String> startingAfter = parsedResponse.getNextPageToken();
                        ...
                        future.complete(new LatticeHttpResponse<>(
                                new SyncPagingIterable<DeletedObjectEntry>(
                                        startingAfter.isPresent(), result, parsedResponse, () -> {
                                            try {
                                                return listDeletedObjects(nextRequest, requestOptions)
                                                        .get()
                                                        .body();
                                            } catch (InterruptedException | ExecutionException e) {
                                                throw new RuntimeException(e);
