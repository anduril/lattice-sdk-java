...
public final class DeleteObjectRequest {
    ...
    private DeleteObjectRequest(Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeleteObjectRequest;
    }
    ...
    public static final class Builder {
        ...
        public DeleteObjectRequest build() {
            return new DeleteObjectRequest(additionalProperties);
        }
    }
}
