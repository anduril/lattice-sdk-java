...
public class AsyncRawTaskingClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTaskingClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<andurilHttpResponse<Task>> createTask() {
     ...
     * be asynchronously updated by their destined agent.
     */
    public CompletableFuture<andurilHttpResponse<Task>> createTask(TaskCreation request) {
    ...
    public CompletableFuture<andurilHttpResponse<Task>> createTask(
        ...
        CompletableFuture<andurilHttpResponse<Task>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<andurilHttpResponse<Task>> getTask(String taskId) {
        return getTask(taskId, null);
    }

    public CompletableFuture<andurilHttpResponse<Task>> getTask(String taskId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/v1/tasks")
     ...
     */
    public CompletableFuture<andurilHttpResponse<Task>> updateTaskStatus(String taskId) {
     ...
     * Update the status of a task.
     */
    public CompletableFuture<andurilHttpResponse<Task>> updateTaskStatus(String taskId, TaskStatusUpdate request) {
     ...
     * Update the status of a task.
     */
    public CompletableFuture<andurilHttpResponse<Task>> updateTaskStatus(
     ...
     */
    public CompletableFuture<andurilHttpResponse<TaskQueryResults>> queryTasks() {
     ...
     * Query for tasks by a specified search criteria.
     */
    public CompletableFuture<andurilHttpResponse<TaskQueryResults>> queryTasks(TaskQuery request) {
    ...
    public CompletableFuture<andurilHttpResponse<TaskQueryResults>> queryTasks(
        ...
        CompletableFuture<andurilHttpResponse<TaskQueryResults>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<andurilHttpResponse<AgentRequest>> listenAsAgent() {
     ...
     * period you will be expected to reinitiate a new request.
     */
    public CompletableFuture<andurilHttpResponse<AgentRequest>> listenAsAgent(AgentListener request) {
    ...
    public CompletableFuture<andurilHttpResponse<AgentRequest>> listenAsAgent(
        ...
        CompletableFuture<andurilHttpResponse<AgentRequest>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
