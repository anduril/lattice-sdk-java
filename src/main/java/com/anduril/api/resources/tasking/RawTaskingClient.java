...
public class RawTaskingClient {
    protected final ClientOptions clientOptions;

    public RawTaskingClient(ClientOptions clientOptions) {
     ...
     */
    public andurilHttpResponse<Task> createTask() {
     ...
     * be asynchronously updated by their destined agent.
     */
    public andurilHttpResponse<Task> createTask(TaskCreation request) {
     ...
     * be asynchronously updated by their destined agent.
     */
    public andurilHttpResponse<Task> createTask(TaskCreation request, RequestOptions requestOptions) {
    ...
    public andurilHttpResponse<Task> getTask(String taskId) {
        return getTask(taskId, null);
    }

    public andurilHttpResponse<Task> getTask(String taskId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/v1/tasks")
     ...
     */
    public andurilHttpResponse<Task> updateTaskStatus(String taskId) {
     ...
     * Update the status of a task.
     */
    public andurilHttpResponse<Task> updateTaskStatus(String taskId, TaskStatusUpdate request) {
     ...
     * Update the status of a task.
     */
    public andurilHttpResponse<Task> updateTaskStatus(
     ...
     */
    public andurilHttpResponse<TaskQueryResults> queryTasks() {
     ...
     * Query for tasks by a specified search criteria.
     */
    public andurilHttpResponse<TaskQueryResults> queryTasks(TaskQuery request) {
     ...
     * Query for tasks by a specified search criteria.
     */
    public andurilHttpResponse<TaskQueryResults> queryTasks(TaskQuery request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
     ...
     */
    public andurilHttpResponse<AgentRequest> listenAsAgent() {
     ...
     * period you will be expected to reinitiate a new request.
     */
    public andurilHttpResponse<AgentRequest> listenAsAgent(AgentListener request) {
     ...
     * period you will be expected to reinitiate a new request.
     */
    public andurilHttpResponse<AgentRequest> listenAsAgent(AgentListener request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
