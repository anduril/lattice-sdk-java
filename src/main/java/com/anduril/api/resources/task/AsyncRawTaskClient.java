...
public class AsyncRawTaskClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTaskClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<LatticeHttpResponse<Task>> getTaskById(String taskId) {
        return getTaskById(taskId, null);
    }

    public CompletableFuture<LatticeHttpResponse<Task>> getTaskById(String taskId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tasks")
    ...
    public CompletableFuture<LatticeHttpResponse<Task>> updateTaskStatusById(String taskId) {
        return updateTaskStatusById(taskId, TaskStatusUpdate.builder().build());
    }

    public CompletableFuture<LatticeHttpResponse<Task>> updateTaskStatusById(String taskId, TaskStatusUpdate request) {
        return updateTaskStatusById(taskId, request, null);
    }

    public CompletableFuture<LatticeHttpResponse<Task>> updateTaskStatusById(
     ...
     */
    public CompletableFuture<LatticeHttpResponse<AgentRequest>> longPollListenAsAgent() {
     ...
     * period you will be expected to reinitiate a new request.
     */
    public CompletableFuture<LatticeHttpResponse<AgentRequest>> longPollListenAsAgent(AgentListener request) {
