...
public class AsyncRawEntitiesClient {
     ...
     */
    public CompletableFuture<andurilHttpResponse<Entity>> publishEntity() {
     ...
     * provenance.sourceUpdateTime is greater than the provenance.sourceUpdateTime of the existing entity.</p>
     */
    public CompletableFuture<andurilHttpResponse<Entity>> publishEntity(Entity request) {
     ...
     * provenance.sourceUpdateTime is greater than the provenance.sourceUpdateTime of the existing entity.</p>
     */
    public CompletableFuture<andurilHttpResponse<Entity>> publishEntity(Entity request, RequestOptions requestOptions) {
        ...
        CompletableFuture<andurilHttpResponse<Entity>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<andurilHttpResponse<Entity>> getEntity(String entityId) {
        return getEntity(entityId, null);
    }

    public CompletableFuture<andurilHttpResponse<Entity>> getEntity(String entityId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/v1/entities")
     ...
     */
    public CompletableFuture<andurilHttpResponse<Entity>> overrideEntity(String entityId, String fieldPath) {
     ...
     * concurrently for the same field path, the last writer wins.</p>
     */
    public CompletableFuture<andurilHttpResponse<Entity>> overrideEntity(
     ...
     */
    public CompletableFuture<andurilHttpResponse<Entity>> removeEntityOverride(String entityId, String fieldPath) {
     ...
     * This operation clears the override value from the specified field path on the entity.
     */
    public CompletableFuture<andurilHttpResponse<Entity>> removeEntityOverride(
     ...
     */
    public CompletableFuture<andurilHttpResponse<EntityEventResponse>> longPollEntityEvents(
    ...
    public CompletableFuture<andurilHttpResponse<EntityEventResponse>> longPollEntityEvents(
        ...
        CompletableFuture<andurilHttpResponse<EntityEventResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
