...
public class AsyncRawEntityClient {
     ...
     */
    public CompletableFuture<LatticeHttpResponse<Entity>> publishEntityRest() {
        return publishEntityRest(Entity.builder().build());
    }
     ...
     * provenance.sourceUpdateTime is greater than the provenance.sourceUpdateTime of the existing entity.</p>
     */
    public CompletableFuture<LatticeHttpResponse<Entity>> publishEntityRest(Entity request) {
        return publishEntityRest(request, null);
    }
     ...
     */
    public CompletableFuture<LatticeHttpResponse<Entity>> publishEntityRest(
            Entity request, RequestOptions requestOptions) {
    ...
    public CompletableFuture<LatticeHttpResponse<Entity>> getEntityById(String entityId) {
        return getEntityById(entityId, null);
    }

    public CompletableFuture<LatticeHttpResponse<Entity>> getEntityById(
     ...
     */
    public CompletableFuture<LatticeHttpResponse<Entity>> putEntityOverrideRest(String entityId, String fieldPath) {
        return putEntityOverrideRest(
                entityId, fieldPath, EntityOverride.builder().build());
    }
     ...
     * concurrently for the same field path, the last writer wins.</p>
     */
    public CompletableFuture<LatticeHttpResponse<Entity>> putEntityOverrideRest(
            String entityId, String fieldPath, EntityOverride request) {
        return putEntityOverrideRest(entityId, fieldPath, request, null);
    }
     ...
     */
    public CompletableFuture<LatticeHttpResponse<Entity>> removeEntityOverrideRest(String entityId, String fieldPath) {
        return removeEntityOverrideRest(entityId, fieldPath, null);
    }

    /**
     * This operation clears the override value from the specified field path on the entity.
     */
    public CompletableFuture<LatticeHttpResponse<Entity>> removeEntityOverrideRest(
    ...
    public CompletableFuture<LatticeHttpResponse<EntityEventResponse>> longPollEntityEvents(
        ...
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entities/events")
                .build();
        RequestBody body;
        try {
            body = RequestBody.create(
