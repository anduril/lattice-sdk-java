...
public class RawEntityClient {
     ...
     */
    public LatticeHttpResponse<Entity> publishEntityRest() {
     ...
     * provenance.sourceUpdateTime is greater than the provenance.sourceUpdateTime of the existing entity.</p>
     */
    public LatticeHttpResponse<Entity> publishEntityRest(Entity request) {
     ...
     * provenance.sourceUpdateTime is greater than the provenance.sourceUpdateTime of the existing entity.</p>
     */
    public LatticeHttpResponse<Entity> publishEntityRest(Entity request, RequestOptions requestOptions) {
    ...
    public LatticeHttpResponse<Entity> getEntityById(String entityId) {
        return getEntityById(entityId, null);
    }

    public LatticeHttpResponse<Entity> getEntityById(String entityId, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("entities")
     ...
     */
    public LatticeHttpResponse<Entity> putEntityOverrideRest(String entityId, String fieldPath) {
     ...
     * concurrently for the same field path, the last writer wins.</p>
     */
    public LatticeHttpResponse<Entity> putEntityOverrideRest(
     ...
     */
    public LatticeHttpResponse<Entity> removeEntityOverrideRest(String entityId, String fieldPath) {
     ...
     * This operation clears the override value from the specified field path on the entity.
     */
    public LatticeHttpResponse<Entity> removeEntityOverrideRest(
