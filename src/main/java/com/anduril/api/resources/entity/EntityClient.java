...
public class EntityClient {
     ...
     */
    public Entity publishEntityRest() {
        return this.rawClient.publishEntityRest().body();
    }
     ...
     * provenance.sourceUpdateTime is greater than the provenance.sourceUpdateTime of the existing entity.</p>
     */
    public Entity publishEntityRest(Entity request) {
        return this.rawClient.publishEntityRest(request).body();
    }
     ...
     * provenance.sourceUpdateTime is greater than the provenance.sourceUpdateTime of the existing entity.</p>
     */
    public Entity publishEntityRest(Entity request, RequestOptions requestOptions) {
        return this.rawClient.publishEntityRest(request, requestOptions).body();
    }

    public Entity getEntityById(String entityId) {
        return this.rawClient.getEntityById(entityId).body();
    }

    public Entity getEntityById(String entityId, RequestOptions requestOptions) {
        return this.rawClient.getEntityById(entityId, requestOptions).body();
    }
     ...
     */
    public Entity putEntityOverrideRest(String entityId, String fieldPath) {
        return this.rawClient.putEntityOverrideRest(entityId, fieldPath).body();
    }
     ...
     * concurrently for the same field path, the last writer wins.</p>
     */
    public Entity putEntityOverrideRest(String entityId, String fieldPath, EntityOverride request) {
        return this.rawClient
     ...
     * concurrently for the same field path, the last writer wins.</p>
     */
    public Entity putEntityOverrideRest(
     ...
     */
    public Entity removeEntityOverrideRest(String entityId, String fieldPath) {
        return this.rawClient.removeEntityOverrideRest(entityId, fieldPath).body();
    }

    /**
     * This operation clears the override value from the specified field path on the entity.
     */
    public Entity removeEntityOverrideRest(String entityId, String fieldPath, RequestOptions requestOptions) {
        return this.rawClient
