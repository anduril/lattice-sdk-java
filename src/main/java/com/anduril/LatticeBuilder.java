...
public class LatticeBuilder {
     ...
     */
    public LatticeBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public LatticeBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public LatticeBuilder retryJitterFactor(double retryJitterFactor) {
